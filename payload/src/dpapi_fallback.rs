//! Fallback app-bound key recovery when IElevator COM is unavailable.
//!
//! Tries layered DPAPI unwrap and Chrome inner AES/ChaCha decryption.
//! Works for some Chromium forks; Chrome itself usually needs IElevator.
...
/// Try recovering a 32-byte app-bound master key without IElevator.
